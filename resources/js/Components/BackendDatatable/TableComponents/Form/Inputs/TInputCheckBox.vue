...
<script>
import { radiusSizeMixin } from "@/Mixins/radiusSizeMixin.js";
import TCheckIcon from "@/Components/BackendDatatable/TableComponents/Icon/TCheckIcon.vue";
    ...
    setup(props, { emit }) {
        ...
        const checkboxStyle = () => {
            ...
            if (color.value === "white") {
                style =
                    "bg-white hover:bg-blue-100 checked:bg-indigo-200 border-gray-300 text-gray-600";
            } else if (color.value === "black") {
                style =
                    "bg-white hover:bg-gray-500 checked:bg-indigo-200 border-black text-gray-100";
            } else {
                style =
                    "bg-white hover:bg-" +
                    color.value +
        ...
        const updateField = () => {
            ...
            if (multipleOption.value) {
                if (!modelValue.value.includes(inputValue.value)) {
                    ...
                    newValue.splice(
                        modelValue.value.indexOf(inputValue.value),
                        1
                    );
                }
            } else {
