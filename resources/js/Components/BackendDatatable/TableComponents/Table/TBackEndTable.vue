<template>
    <div class="table-outside-container" :class="`table-${design}`">
        <!--Top Content-->
        <div
            v-if="
                hasSlot('search') ||
                hasSlot('top-right') ||
                hasSlot('top-left') ||
                simpleSearchableFields.length > 0
            "
            class="table-top"
        >
            <!--Left-->
            ...
            <!--Right-->
            <div v-if="hasSlot('top-right')" class="table-top-right">
        ...
        <transition name="tableSearch">
            <div v-if="showAdvancedSearchPanel">
                <div
                    ...
                    <div class="table-advanced-search-content-wrapper">
                        ...
                        >
                            <t-input-group :label="field.label">
                                ...
                                <t-input-text
                                    v-if="
                                        field.advancedSearchInputType === 'text'
                                    "
                                    v-model="
                                    ...
                                    :options-label-key="
                                        field.advancedSearchSelectLabelKey
                                    "
                                    :options-value-key="
                                        field.advancedSearchSelectValueKey
                                    "
                                    :select-position="
                                        field.compareOperators ? 'right' : ''
                                    "
                                    select-type="inside"
                                />
                                <!--Select-->
                                <t-input-select
                                    ...
                                    "
                                    :options="
                                        field.advancedSearchSelectInputSource
                                    "
                                    :options-label-key="
                                        field.advancedSearchSelectLabelKey
                                    "
                                    ...
                                    :search-place-holder="
                                        field[
                                            'advancedSearchSelectSearchPlaceHolder'
                                        ] !== null
                                            ? field[
                                                  'advancedSearchSelectSearchPlaceHolder'
                                              ]
                                    ...
                                    :place-holder="
                                        field[
                                            'advancedSearchSelectPlaceHolder'
                                        ] !== null
                                            ? field[
                                                  'advancedSearchSelectPlaceHolder'
                                              ]
        ...
        >
                        ...
                        >
                            <div
                                ...
                                @click="
                                    sortableFields.includes(item.key)
                                        ? [
                                              (searchObj.sortKey = item.key),
                                              (searchObj.sortDirection =
                                                  !searchObj.sortDirection),
                                          ]
                                        : ''
                                "
                            >
                                ...
                                <!--Sort Icon-->
                                <span
                                    v-show="sortableFields.includes(item.key)"
                                >
            ...
            <div
                ...
                v-if="
                    content.per_page
                        ? content.total >= content.per_page
                        : content.meta.total >= content.meta.per_page
                "
            >
                <t-paginate
                    v-model="activePage"
    ...
    <teleport to="body">
        ...
        >
                            ...
                            >
                                ...
                                >
                                    <rect
                                        style="
                                            fill: none;
                                            fill-opacity: 0.694779;
                                            stroke-width: 2.22226;
                                            stroke-linecap: round;
                                            stroke-linejoin: round;
                                            stroke-miterlimit: 8;
                                        "
            ...
            <template #footer-left>
                <div
                    class="inline-flex whitespace-nowrap items-center space-x-2"
                >
...
import TInputCheckBox from "@/Components/BackendDatatable/TableComponents/Form/Inputs/TInputCheckBox.vue";
import TInputSelect from "@/Components/BackendDatatable/TableComponents/Form/Inputs/TInputSelect.vue";
...
import TInputGroup from "@/Components/BackendDatatable/TableComponents/Form/TInputGroup.vue";
import TInputText from "@/Components/BackendDatatable/TableComponents/Form/Inputs/TInputText.vue";
import TInputBetween from "@/Components/BackendDatatable/TableComponents/Form/Inputs/TInputBetween.vue";
import TPaginate from "@/Components/BackendDatatable/TableComponents/Paginate/TPaginate.vue";
import TAlert from "@/Components/BackendDatatable/TableComponents/Alert/TAlert.vue";
...
export default defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        const contentCellStyle = (itemIndex, cellIndex) => {
            ...
            if (regeneratedContent.value.length > 1) {
                if (itemIndex === 1 && cellIndex === 1) {
                    ...
                    itemIndex === 1 &&
                    cellIndex === regeneratedHeader.value.length &&
                    actions.value.length === 0
                ) {
                    /*Top Right*/
                    style.push("radius-tr-" + radius.value);
                } else if (
                    itemIndex === regeneratedContent.value.length &&
                    cellIndex === 1
                ) {
                    /*Bottom Left*/
        ...
        onBeforeMount(() => {
            ...
            header.value.forEach((item) => {
                if (item.advancedSearchable) {
                    advancedSearchableFields.push({
                        ...item,
                        searchKey: item.advancedSearchKey
                            ? item.advancedSearchKey
                            : item.key,
                    });
                }
            });
            ...
            advancedSearchableFields.forEach((item) => {
                searchObj.advancedSearchFields[item.searchKey] = {
                    value:
                        item.advancedSearchInputType === "between"
                            ? { from: null, to: null }
                            : null,
                    condition: item["compareOperators"]
                        ? item["compareOperators"].length > 0
                            ? item["compareOperators"][0].key
                            : null
                        : null,
                };
            });
                ...
                router.post(
                    route(searchRoute.value),
                    {
                        [requestSearchKey.value]: {
                            ...
                            searchValue:
                                searchObj.searchType === "simple"
                                    ? {
                                          simpleSearchText:
                                              searchObj.simpleSearchText,
                                          simpleSearchFields:
        ...
        const selectItem = ($event, item, type) => {
            emit("selectedItem", {
                data: content.value.data.find(
                    (i) => i[uniqueId.value] === item[uniqueId.value]
                ),
                action: type,
            });
        };
        ...
        const tableErrors = computed(() => {
            ...
            return [
                ...
                },
                {
                    ...
                    title: "Content Key",
                    errorText: "contentKeyError",
                },
                {
                    status: searchRouteStatus,
                    title: "Search Route",
                    errorText: "searchRouteError",
                },
            ];
        });
...
<style scoped>
.tableSearch-enter-active,
.tableSearch-leave-active {
    transition: all 700ms;
}

.tableSearch-enter-from,
.tableSearch-leave-to {
    opacity: 0;
    max-height: 0;
}

.tableSearch-enter-to,
.tableSearch-leave-from {
    opacity: 1;
    max-height: 500px;
}
