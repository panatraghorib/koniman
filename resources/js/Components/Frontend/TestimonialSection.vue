        ...
        <div class="container px-4">
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                    <div
                        class="ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial"
                        data-aos-delay="70"
                        data-aos="fade-up"
                    ...
                    >
                        <div
                            class="ud-testimonial-ratings flex items-center mb-3"
                        >
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">
                                ...
                                It's clean. It's distraction free. If you're
                    ...
                    >
                        ...
                        <div class="ud-testimonial-info flex items-center">
                            <div
                                class="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5"
                            >
                                <img :src="AuthorThree" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">
                                    William Smith
                    ...
                    <div class="wow fadeInUp" data-wow-delay=".2s">
                        <div class="ud-title mb-8">
                            ...
                            >
                                Some Of Our Clients
                                <span
                                    class="w-8 h-[1px] inline-block bg-[#afb2b5] ml-4"
                                >
                                </span>
                            </h6>
                        </div>
                        <div class="ud-brands-logo flex items-center flex-wrap">
                            <div
                                class="ud-single-logo mr-10 mb-5 max-w-[140px]"
                            >
                                <a
