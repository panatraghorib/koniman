        ...
        <div class="container">
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full lg:w-1/2 px-4">
                    <div
                        class="single-faq w-full bg-white border border-[#F3F4FE] rounded-lg p-5 sm:p-8 mb-8"
                        data-aos-delay="70"
                        data-aos="fade-up"
                    ...
                    >
                        <button
                            class="faq-btn flex items-center w-full text-left"
                        >
                            <div
                        ...
                        <div class="faq-content pl-[62px] hidden">
                            <p
                                class="text-base text-body-color leading-relaxed py-3"
                            >
