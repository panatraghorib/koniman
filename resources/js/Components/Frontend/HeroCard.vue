        ...
        <div class="container">
            <div class="flex flex-wrap items-center -mx-4">
                <div class="w-full px-4">
                    <div
                        class="hero-content text-center max-w-[780px] mx-auto"
                        data-aos="fade-up"
                        data-aos-delay="50"
                    ...
                    >
                        ...
                        >
                            Open-Source Web Template for SaaS, Startup, Apps,
                            and More
                        </h1>
                        <p
                        ...
                        >
                            ...
                            Favourite Technology - HTML Bootstrap, Tailwind and
                            React NextJS.
                        </p>
                        <ul
                            class="flex flex-wrap items-center justify-center mb-10"
                        >
                            <li>
                                <a
                ...
                <div class="w-full px-4">
                    <div
                        class="mx-auto max-w-[845px] relative z-10"
                        data-aos="fade-up"
                        data-aos-delay="80"
                        data-aos-duration="1000"
                        data-aos-easing="ease-in-out"
