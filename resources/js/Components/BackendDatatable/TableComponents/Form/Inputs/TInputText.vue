<template>
    ...
    <div
        ...
        ref="withSelectInput"
        :class="[
            errors.length > 0 ? `border border-red-500 radius-${radius}` : '',
        ]"
    >
        <!--Outside Icon-->
        <div
        ...
        <div
            ...
            :class="[
                selectPosition === 'left' && options[0][optionsValueKey]
                    ? 'border-r'
                    : '',
                hasSlot('icon') && iconType === 'outside'
                    ? ''
                    : `border-l radius-l-${radius}`,
            ]"
        >
        ...
        <div
            ...
            @click="
                disabled || readOnly === 'select' || readOnly === 'both'
                    ? ''
        ...
        >
            ...
            >
                ...
                <span
                    ...
                    v-text="
                        options.find((o) => o[optionsValueKey] === selectValue)[
                            optionsLabelKey
                        ]
                    "
                />
                ...
                <svg
                    ...
                    :class="[
                        ...
                        selectType !== 'inside'
                            ? '-rotate-90'
                            : '',
                        (showSelectList && selectPosition === 'right') ||
                        (showSelectList && selectType === 'inside')
                            ? 'rotate-90'
                            : '',
                ...
                <template v-for="item in options">
                    <div
                        @click.stop="
                            ...
                            $emit('update:selectValue', item[optionsValueKey]);
                        "
        ...
        <div class="flex flex-grow">
            ...
            <input
                ...
                :disabled="
                    disabled || readOnly === 'text' || readOnly === 'both'
                "
        ...
        >
            ...
            <div
                class="text-input-select-trigger"
                :class="[
                    hasSlot('append') || append
                        ? ''
                        : `border-r radius-r-${radius}`,
                    disabled || readOnly === 'select' || readOnly === 'both'
                        ? 'cursor-not-allowed'
                        : 'cursor-pointer',
                    { 'input-disabled': disabled },
        ...
        <div
            ...
            :class="[
                `radius-r-${radius}`,
                selectPosition === 'right' && options[0][optionsValueKey]
                    ? 'border-l'
                    : ``,
            ]"
        >
    ...
    setup(props, { slots }) {
        ...
        const inputStyle = computed(() => {
            ...
            if (
                prepend.value ||
                hasSlot("prepend") ||
                selectPosition.value === "left" ||
                (hasSlot("icon") && iconType.value === "outside")
            ) {
