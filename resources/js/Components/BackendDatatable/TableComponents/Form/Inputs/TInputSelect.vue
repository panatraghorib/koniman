<template>
    ...
    >
        <!--Select Container-->
        <div class="select-container" @click="updateOptionsShowStatus">
            <!--Icon-->
            <div
                v-if="hasSlot('icon')"
                ...
                >
                    ...
                    <template v-for="(option, index) in searchedList">
                            ...
                            :class="[
                                'select-option-item',
                                {
                                    'select-option-active-item':
                                        modelValue === option[optionsValueKey],
                                },
                                `radius-${radius}`,
                            ]"
                        ...
                        >
                            ...
                            <!--Simple Text Label-->
                            <span v-else v-text="option[optionsLabelKey]" />

                            <!--Selected Indicator Icon-->
                            <svg
                                v-if="modelValue === option[optionsValueKey]"
                                xmlns="http://www.w3.org/2000/svg"
    ...
    setup(props, { emit, slots }) {
        ...
        const selectedOption = computed(() => {
            ...
            return options.value.find(
                (option) => option[optionsValueKey.value] === modelValue.value
            );
        });
