...
import BrandImage from "/public/play/images/hero/brand.svg";
import HeroImage from "/public/play/images/hero/hero-image.jpg";
// import DotedImage from "/public/play/images/hero/doted.png";
</script>
...
<template>
    ...
    <PublicLayout>
        <div
            id="home"
            class="relative overflow-hidden bg-blue-dark pt-[120px] md:pt-[130px] lg:pt-[160px]"
        >
            <div class="container">
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4">
                        ...
                        >
                            ...
                            <p
                                class="mx-auto mb-9 max-w-[600px] font-medium text-base text-white sm:text-lg sm:leading-[1.44]"
                            >
                                Multidisciplinary Web Template Built with Your
                                Favourite Technology - HTML Bootstrap, Tailwind
                                and React NextJS.
                            </p>
                            <ul
                                class="mb-10 flex gap-5 flex-wrap items-center justify-center"
                            >
                                <li>
                                    <a
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        >
                                            <g
                                                clip-path="url(#clip0_2005_10818)"
                                            >
                                                <path
