        ...
        <div class="relative -mx-4 flex items-center justify-between">
            ...
            <div class="flex w-full items-center justify-between px-4">
                <div>
                    ...
                    >
                        <NavbarList :menu="menu" @menu-click="menuClick" />
                    </nav>
                </div>
                <div class="justify-end pr-16 flex items-center lg:pr-0">
                    ...
                    <div class="hidden sm:flex">
                        <a
                            href="/login"
                            class="ml-4 loginBtn py-2 px-[22px] text-base font-medium text-white hover:opacity-70 rounded-md bg-white bg-opacity-20 duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark"
                        >
                            Sign In
                        </a>
                    </div>
